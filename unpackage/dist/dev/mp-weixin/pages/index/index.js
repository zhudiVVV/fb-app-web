...
/***/ 168:
/*!*********************************************************************************************************************!*\
  !*** /Users/zhudi/Documents/workSpace/workpersonal/fb/mall-app-web-master/main.js?{"page":"pages%2Findex%2Findex"} ***!
  \*********************************************************************************************************************/
...
/***/ 169:
/*!**************************************************************************************************!*\
  !*** /Users/zhudi/Documents/workSpace/workpersonal/fb/mall-app-web-master/pages/index/index.vue ***!
  \**************************************************************************************************/
/*! no static exports found */
...
/***/ 170:
/*!*********************************************************************************************************************************!*\
  !*** /Users/zhudi/Documents/workSpace/workpersonal/fb/mall-app-web-master/pages/index/index.vue?vue&type=template&id=57280228& ***!
  \*********************************************************************************************************************************/
...
var render = function () {
  ...
  var f0 =
    _vm.homeFlashPromotion !== null
      ? _vm._f("formatTime")(_vm.homeFlashPromotion.nextStartTime)
      : null
...
/***/ 172:
/*!***************************************************************************************************************************!*\
  !*** /Users/zhudi/Documents/workSpace/workpersonal/fb/mall-app-web-master/pages/index/index.vue?vue&type=script&lang=js& ***!
  \***************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ 173:
/*!**********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--13-1!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/script.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!/Users/zhudi/Documents/workSpace/workpersonal/fb/mall-app-web-master/pages/index/index.vue?vue&type=script&lang=js& ***!
  \**********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _productCategory = __webpack_require__(/*! @/api/productCategory */ 37);
//
//
//
//
...
var _default = {
  ...
  onReachBottom: function onReachBottom() {
    ...
    (0, _home.fetchRecommendProductList)(this.recommendParams).then(function (response) {
      var addProductList = response.data;
      if (response.data.length === 0) {
        //没有更多了
        _this.recommendParams.pageNum--;
        _this.loadingType = 'nomore';
      } else {
        _this.recommendProductList = _this.recommendProductList.concat(addProductList);
        _this.loadingType = 'more';
      }
    });
  },
  computed: {
    cutDownTime: function cutDownTime() {
      var endTime = new Date(this.homeFlashPromotion.endTime);
      var endDateTime = new Date();
      var startDateTime = new Date();
      endDateTime.setHours(endTime.getHours());
      endDateTime.setMinutes(endTime.getMinutes());
      endDateTime.setSeconds(endTime.getSeconds());
      var offsetTime = endDateTime.getTime() - startDateTime.getTime();
      var endHour = Math.floor(offsetTime / (60 * 60 * 1000));
      var offsetMinute = offsetTime % (60 * 60 * 1000);
      var endMinute = Math.floor(offsetMinute / (60 * 1000));
      var offsetSecond = offsetTime % (60 * 1000);
      var endSecond = Math.floor(offsetSecond / 1000);
      return {
        endHour: endHour,
        endMinute: endMinute,
        endSecond: endSecond
  ...
  methods: {
        ...
        return _regenerator.default.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _this2.$fbApi.productCategoryListFirst().then(function (res) {
                  console.dir(res);
                  _this2.menuArr = res.data.content || [];
                });
    ...
    swiperChange: function swiperChange(e) {
      ...
      var changeIndex = index % this.titleNViewBackgroundList.length;
    ...
    //广告详情页
    navToAdvertisePage: function navToAdvertisePage(item) {
      var id = item.id;
      console.log("navToAdvertisePage", item);
    },
    //品牌详情页
    navToBrandDetailPage: function navToBrandDetailPage(item) {
      var id = item.id;
      uni.navigateTo({
    ...
    //推荐品牌列表页
    navToRecommendBrandPage: function navToRecommendBrandPage() {
      uni.navigateTo({
        url: "/pages/brand/list"
      });
    },
    //新鲜好物列表页
    navToNewProudctListPage: function navToNewProudctListPage() {
      uni.navigateTo({
        url: "/pages/product/newProductList"
      });
    },
    //人气推荐列表页
    navToHotProudctListPage: function navToHotProudctListPage() {
      uni.navigateTo({
...
/***/ 176:
/*!************************************************************************************************************************************!*\
  !*** /Users/zhudi/Documents/workSpace/workpersonal/fb/mall-app-web-master/pages/index/index.vue?vue&type=style&index=0&lang=scss& ***!
  \************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
