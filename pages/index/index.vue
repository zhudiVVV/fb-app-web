<template>
	<view class="container">
		...
		<view class="cate-section">
			...
			<view v-for="(item, index) in menuArr" :key="index" class="cate-item">
...
<script>
  ...
  import {productCategoryList, productCategoryListFirst, productCategoryWithChildren} from "@/api/productCategory";
	export default {
		components: {
			uniLoadMore
		},
		...
		methods: {
			 ...
			 */
			async loadData() {
        this.$fbApi.productCategoryListFirst().then(res => {
          console.dir(res)
          this.menuArr = res.data.content || []
        })
